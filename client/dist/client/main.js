...
var AppComponent = /** @class */ (function () {
    ...
    ;
    AppComponent.prototype.getAllFromService = function () {
        var _this = this;
    ...
    ;
    AppComponent.prototype.getOneFromService = function (id) {
        var _this = this;
    ...
    ;
    AppComponent.prototype.newCakeToService = function (cake) {
        var _this = this;
        var cakeObject = { baker: cake.baker, imagepath: cake.imagepath, averagestars: 0, reviews: [] };
        var observable = this._httpService.newCake(cakeObject);
        observable.subscribe(function (data) {
            console.log(data);
            _this.singleCake = data;
        });
...
/* harmony import */ var _show_cake_show_cake_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./show-cake/show-cake.component */ "./src/app/show-cake/show-cake.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _show_cake_show_cake_component__WEBPACK_IMPORTED_MODULE_6__["ShowCakeComponent"]
            ],
            imports: [
...
/***/ "./src/app/show-cake/show-cake.component.html":
/*!****************************************************!*\
  !*** ./src/app/show-cake/show-cake.component.html ***!
  \****************************************************/
/*! no static exports found */
...
var ShowCakeComponent = /** @class */ (function () {
    ...
    ShowCakeComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./show-cake.component.html */ "./src/app/show-cake/show-cake.component.html"),
            styles: [__webpack_require__(/*! ./show-cake.component.css */ "./src/app/show-cake/show-cake.component.css")]
        }),
        __metadata("design:paramtypes", [])
    ], ShowCakeComponent);
    return ShowCakeComponent;
}());
...
module.exports = __webpack_require__(/*! C:\Users\alexa\Desktop\DojoAssignments\MEAN\cakes\client\src\main.ts */"./src/main.ts");
